...
//------------------------STACK OVERFLOW ANSWER------------------------------------------
        Firebase.auth()
            ...
            .then(async cred => {
                ...
                console.log('SETTING ID FROM AUTH FUNCTION'+this.state.id);
            ...
            .then(() => this.props.navigation.navigate('Tasks_1'))
